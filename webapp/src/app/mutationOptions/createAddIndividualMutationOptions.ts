...
export default function createAddIndividualMutationOptions(ontologyId: string) {
  ...
  return mutationOptions({
    mutationFn: (payload: AddIndividualPayload) => addIndividual(ontologyId, payload),
    onSuccess: (data) => {
...
const addIndividual = async (ontologyId: string, payload: AddIndividualPayload): Promise<OperationResponse> => {
